...
const STAGES = [
  { id: "lead", title: "🎯 Lead", color: "bg-slate-50" },
  { id: "research", title: "🔍 Research", color: "bg-blue-50" },
  { id: "contacte", title: "📧 Contacte", color: "bg-indigo-50" },
  { id: "demo_pendent", title: "📊 Demo Pendent", color: "bg-purple-50" },
  { id: "demo_ok", title: "✨ Demo OK", color: "bg-purple-100" },
  { id: "oferta", title: "📄 Oferta", color: "bg-orange-50" },
  { id: "documentacio", title: "📁 Documentació", color: "bg-slate-100" },
  { id: "aprovacio", title: "⚖️ Aprovació", color: "bg-amber-100" },
  { id: "contracte", title: "✅ Contracte", color: "bg-emerald-50" },
  { id: "client", title: "🎉 Client", color: "bg-green-100" },
